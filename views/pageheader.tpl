...
<div class="page-sidebar">
    <ul class="x-navigation">
        ...
        <li>
            <a href="/category"><span class="fa fa-desktop"></span> <span class="xn-text">分类列表</span></a>
        </li>
        <li>
            <a href="/articles?page=1"><span class="fa fa-desktop"></span> <span class="xn-text">文章列表</span></a>
        </li>
